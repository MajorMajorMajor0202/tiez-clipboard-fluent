                            ...
                            {props.persistentLimitEnabled && (
                                <div className="setting-item">
                                    ...
                                    <FluentNumberBox
                                        ...
                                        max={99999}
                                        onChange={(v) => {
                                            setPersistentLimitDraft(v.toString());
                                            props.setPersistentLimit(v);
                                            props.saveAppSetting('persistent_limit', v.toString());
                                        }}
                                    />
                                </div>
                            )}
                    ...
                    <div className="setting-item" style={{ flexDirection: 'column', alignItems: 'flex-start', gap: '6px' }}>
                        ...
                        {props.privacyRulesOpen && (
                            <textarea
                                ...
                                style={{ width: 'calc(100% - 30px)', maxWidth: '100%', minHeight: '80px', marginLeft: '30px', boxSizing: 'border-box' }}
